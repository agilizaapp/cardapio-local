<template>
  <Teleport to="body">
    ...
    >
      ...
      <!-- Modal Content -->
      <Card
        class="relative w-full sm:max-w-4xl max-h-[98dvh] overflow-hidden flex flex-col md:flex-row rounded-t-3xl sm:rounded-3xl shadow-2xl z-10 animate-in fade-in slide-in-from-bottom-4 sm:zoom-in-95 duration-300 border-[var(--border-subtle)]"
      ...
      >
        ...
        <!-- Image Section -->
        <div
          class="w-full md:w-1/2 h-64 md:h-auto flex-shrink-0"
        ...
        <div class="w-full md:w-1/2 flex flex-col p-6 md:p-8 overflow-y-auto">
            ...
            >
              ...
              <div class="flex flex-wrap gap-2">
                <Button
                  ...
                  :style="
                    !isOptionSelected(group.name, option)
                      ? { color: 'currentColor' }
                      : {}
                  "
                >
          ...
          <!-- Footer -->
          <div
            class="mt-auto pt-6 border-t border-[var(--border-subtle)] flex flex-col gap-4"
          >
            <div class="flex items-center justify-between">
              <span
                ...
                >Total</span
              >
              <span class="text-xl font-bold" style="color: currentColor">{{
                formattedPrice
              }}</span>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-3">
                ...
                <span
                  class="w-6 text-center font-bold text-sm"
                  style="color: currentColor"
                  >{{ quantity }}</span
                >
                <button
